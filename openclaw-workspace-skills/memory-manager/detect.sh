...
WORKSPACE="${OPENCLAW_WORKSPACE:-${OPENCLAW_WORKSPACE_DIR:-$HOME/.openclaw/workspace}}"
...
if [ "$usage" -ge 85 ]; then
  ...
  echo "  1. Run: $SCRIPT_DIR/snapshot.sh"
  echo "  2. Run: $SCRIPT_DIR/organize.sh"
  ...
  echo "  1. Run: $SCRIPT_DIR/organize.sh"
